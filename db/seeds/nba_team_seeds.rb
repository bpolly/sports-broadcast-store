...
atl = Team.find_or_create_by(name: "atlanta hawks", slug: "nba-atl", league: league, nbc_team_id: 1)
["atlanta hawks", "atlanta", "hawks"].each do |nick|
  atl.nicknames.find_or_create_by(name: nick)
end

bos = Team.find_or_create_by(name: "boston celtics", slug: "nba-bos", league: league, nbc_team_id: 2)
...
cha = Team.find_or_create_by(name: "charlotte hornets", slug: "nba-cha", league: league, nbc_team_id: 30)
["charlotte hornets", "charlotte", "hornets"].each do |nick|
  cha.nicknames.find_or_create_by(name: nick)
end


chi = Team.find_or_create_by(name: "chicago bulls", slug: "nba-chi", league: league, nbc_team_id: 4)
...
det = Team.find_or_create_by(name: "detroit pistons", slug: "nba-det", league: league, nbc_team_id: 8)
...
hou = Team.find_or_create_by(name: "houston rockets", slug: "nba-hou", league: league, nbc_team_id: 10)
["houston rockets", "houston", "rockets"].each do |nick|
  hou.nicknames.find_or_create_by(name: nick)
end


ind = Team.find_or_create_by(name: "indiana pacers", slug: "nba-ind", league: league, nbc_team_id: 11)
...
mia = Team.find_or_create_by(name: "miami heat", slug: "nba-mia", league: league, nbc_team_id: 14)
["miami heat", "miami", "heat"].each do |nick|
  mia.nicknames.find_or_create_by(name: nick)
end


mil = Team.find_or_create_by(name: "milwaukee bucks", slug: "nba-mil", league: league, nbc_team_id: 15)
["milwaukee bucks", "milwaukee", "bucks"].each do |nick|
  mil.nicknames.find_or_create_by(name: nick)
end


min = Team.find_or_create_by(name: "minnesota timberwolves", slug: "nba-min", league: league, nbc_team_id: 16)
["minnesota timberwolves", "minnesota", "wolves", "timberwolves"].each do |nick|
  min.nicknames.find_or_create_by(name: nick)
end


no = Team.find_or_create_by(name: "new orleans pelicans", slug: "nba-no", league: league, nbc_team_id: 3)
...
orl = Team.find_or_create_by(name: "orlando magic", slug: "nba-orl", league: league, nbc_team_id: 19)
...
pho = Team.find_or_create_by(name: "phoenix suns", slug: "nba-pho", league: league, nbc_team_id: 21)
...
sac = Team.find_or_create_by(name: "sacramento kings", slug: "nba-sac", league: league, nbc_team_id: 23)
["sacramento kings", "sacramento", "kings"].each do |nick|
  sac.nicknames.find_or_create_by(name: nick)
end


sa = Team.find_or_create_by(name: "san antonio spurs", slug: "nba-sa", league: league, nbc_team_id: 24)
...
uta = Team.find_or_create_by(name: "utah jazz", slug: "nba-uta", league: league, nbc_team_id: 26)
["utah jazz", "utah", "jazz"].each do |nick|
  uta.nicknames.find_or_create_by(name: nick)
end


was = Team.find_or_create_by(name: "washington wizards", slug: "nba-was", league: league, nbc_team_id: 27)
