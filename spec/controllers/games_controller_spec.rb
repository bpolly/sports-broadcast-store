...
RSpec.describe GamesController do
  describe 'retrieve_given_params' do
    ...
    let(:team_one) { FactoryGirl.create(:team, :nba)}
    let(:team_two) { FactoryGirl.create(:team, :nba)}
    let(:game) { FactoryGirl.create(:game, home_team_id: team_one.id, away_team_id: team_two.id)}
